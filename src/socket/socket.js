...
//   io.sendLikeUpdate = (payload, ownerId = null) => {
//     try {
//       if (payload.targetType === 'user' && !payload.toUserId) {
//         payload.toUserId = payload.targetId;
//       }
...
//             } catch (e) {
//               console.warn('[io.sendLikeUpdate] emit to owner socket error', e);
//             }
//           }
//         }
//       }
...
//       } catch (e) {
//         console.warn('[io.sendLikeUpdate] global emit error', e);
//       }
//     } catch (e) {
//       console.error('[io.sendLikeUpdate] unexpected error', e);
//     }
//   };
